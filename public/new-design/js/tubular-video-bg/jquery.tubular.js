...
// default params
var videoWidth = 1600; // needed a default value -- this is overwritten almost immediately
...
jQuery.fn.tubular = function(videoId,wrapperId) {
	...
	var iframe = '<iframe id="myytplayer" width="' + videoWidth + '" height="' + videoHeight + '" src="http://www.youtube.com/embed/' + videoId + '?autoplay=1&controls=0&modestbranding=1&showinfo=0&version=3&wmode=transparent" frameborder="0" allowfullscreen></iframe>';
