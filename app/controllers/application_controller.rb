class ApplicationController < ActionController::Base
  ...
  # :-:-:-:-:-:-:-:-:-:-:-:-:-:-:-:-:-:-:-:-:-:-:-:-:-:-:-:-:-:-:
    ...
    site_name   = "Wilson Investment Properties, Inc"
    ...
    defaults = {
      ...
      keywords:    ["investment properties in texas", "investment properties in dallas", "investment properties in houston", "investment properties in california", "investment properties in los angeles", "investment properties in san francisco"],
      twitter: {
        site_name: site_name,
        site: '@thecookieshq',
        card: 'summary',
